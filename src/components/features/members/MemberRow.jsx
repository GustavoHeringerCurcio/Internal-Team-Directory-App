...
/**
 * MemberRow Component
 * Individual member card for mobile layout
 */
  ...
  return (
    <div
      ...
      className={`
        ...
        ${isSelected ? "border-2 border-blue-500 bg-blue-100" : "border-2 border-transparent bg-white"}
      `}
    >
      {/* Action Menu */}
      <button
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <p className="text-base font-semibold text-gray-900 leading-tight">{member.name}</p>
          </div>

          {/* Role */}
          <span className={`text-xs font-medium w-fit px-2 py-0.5 rounded-full ${roleColors.bg} ${roleColors.text}`}>
            {member.role}
          </span>
