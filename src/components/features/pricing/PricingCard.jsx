  ...
  return (
    <div
      className={`w-full md:w-full max-w-sm p-6 rounded-base shadow-xs border
        ${highlighted ? "bg-brand-soft border-brand" : "bg-neutral-primary-soft border-default"}
      `}
    >
      ...
      <button
        ...
        className={`my-5 w-full text-white shadow-xs font-medium rounded-base text-sm px-4 py-2.5 focus:outline-none transition
          ${
            highlighted
        ...
        {features.map((feature, index) => (
          <li
            ...
            className={`flex items-center ${
              !feature.included ? "line-through decoration-body text-body" : "text-body"
            }`}
          >
            <svg
